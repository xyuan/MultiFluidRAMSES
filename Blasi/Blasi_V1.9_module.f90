!===========================================================================================!
! Blasi's non-linear model for Diffusive Shock Acceleration                v 1.9 (02/04/10) !
!===========================================================================================!
! units:                                                                                    !
    ...
    do i_sol=1,n_sol
        ...
        if(abs(Emax_e)>0)then
            call accel_electrons(kappa, chi, Emax_e, alpha, pres, &                                            ! electrons parameters
                                 Rsub(i_sol), n0*Rtot(i_sol), T2(i_sol), prec(i_sol)%u(0), prec(i_sol)%B(0), & ! shock parameters
...
!===========================================================================================
    ...
    call solve_coupled_system(Gth, u0, P0, T0, Ms0, Ma0, zeta, Rprec_i, &
                              ...
                              Rsub_i, Rtot_i, P2_i, T2_i, Pw2_i, pinj_xi_i, eta_xi_i, p_i, f_i, phi_i, U_i, imax_i)
...
!===========================================================================================
 subroutine solve_coupled_system(Gth, u0, P0, T0, Ms0, Ma0, zeta, Rprec, &
                                 pres, Emax, tmax, xmax, xi, pinj0, eta0, D0, alpha, B0, &
                                 Rsub, Rtot, P2, T2, Pw2, pinj_xi, eta_xi, p, f, phi, U, imax)
!===========================================================================================
...
!===========================================================================================
    ...
    if(Emax+tmax+xmax<=0)then
      pmax = pinj
      return
!      call error("set_pmax","maximum energy not defined",.true.)
    endif
...
!===========================================================================================
 subroutine accel_electrons(kappa, chi, Emax_e, alpha, pres, Rsub, n2_p, T2_p, u1, B1, lnp_p, lnf_p, &
                            p_e, f_e)
!===========================================================================================
...
!===========================================================================================
    ...
    real*8::temp
    real*8::pinj_e_left,pinj_e_right,delta,fe_i
    integer::i,j,n_e
