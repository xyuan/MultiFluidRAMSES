...
!===========================================================================================
    ...
    do iSh=+1,-1,-2
        ...
        if(allocated(SNR(iSh)%Pg  )) deallocate(SNR(iSh)%Pg  )
...
!===========================================================================================
    ...
    do while (iSh*w_i <= w_CD.and.iSh*w_test <= w_CD)
        ...
        if (i>i_max) then
            ...
            call reallocate(SNR(iSh)%Pg  ,0,i_max+TECH%Nmax)
            call reallocate(SNR(iSh)%C2  ,0,i_max+TECH%Nmax)
            call reallocate(SNR(iSh)%W   ,0,i_max+TECH%Nmax)
    ...
    call reallocate(SNR(iSh)%Pg  ,0,SNR(iSh)%N)
    call reallocate(SNR(iSh)%C2  ,0,SNR(iSh)%N)
    call reallocate(SNR(iSh)%W   ,0,SNR(iSh)%N)
