!===========================================================================================!
! Chevalier's model for young supernova remnants                                     v 2.1H !
!===========================================================================================!
! simple test program for the module                                                        !
!===========================================================================================!
! Gilles Ferrand (CEA/Irfu/SAp)                                           08/2010 - 03/2011 !
!===========================================================================================!
...
program Chevalier
    ...
    SNR(-1:+1)%T0   = 1d4  ! upstream temperature [K]
    
    ! set acceleration parameter (ONLY ONE OF THE FOUR MUST BE SET)
    ...
    TECH%verbose = 1     ! level of verbosity
    TECH%step    = 1d-5  ! integrator step
