...
module cooling_module
  ...
  ! On DOIT AVOIR OU teyssier OU theuns OU madau OU weinberg 
  ! OU weinbergint avec un OU exclusif
...
!=======================================================================
  ...
  real(kind=8),dimension(1:91) :: excess_prime_sd93 = (/ & 
       ...
       & 0.1669769, 0.3999939, 0.1470032, 0.1470032, 0.4000244, 0.1260071,0.0 /)
  ...
  real(kind=8)::c1=0.4,c2=30.0,TT0=1d5,TTC=1d7,alpha1=0.15
  real(kind=8)::ux,g_courty,f_courty=1d0
  integer::iT,iZ
