...
subroutine write_screen
  ...
  ! values will be used by post-processing functions
  ! so they can't be formated: we must keep exact values
  if(myid==1)write(*,*)' Output ',ncell,' cells at t = ',t
