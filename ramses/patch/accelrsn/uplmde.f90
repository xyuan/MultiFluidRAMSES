!==================================================!
! GODUNOV SCHEME: INTERFACES RECONSTRUCTION (PLM)  !
!==================================================!
! subroutine tracex                                !
! subroutine tracexyd                              !
! subroutine tracexyz                              !
...
subroutine tracexy(q,dq,c,qm,qp,dx,dy,dt,ngrid)
  ...
  real(dp)::cc, ccc, csq, r, u, v, p, a, g
     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              spx = half*dtdy*(-v*dpy - (dvy)*g*p)

              sry = half*dtdx*(-u*drx - (dux)*r      )
              suy = half*dtdx*(-u*dux - (dpx)/r      )
              svy = half*dtdx*(-u*dvx                )
              spy = half*dtdx*(-u*dpx - (dux)*g*p)
...
subroutine tracexyz(q,dq,c,qm,qp,dx,dy,dz,dt,ngrid)
  ...
  real(dp)::cc, ccc, csq, r, u, v, w, p, a, g
     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              spx = half*dtdx*(-v*dpy-w*dpz - (dvy+dwz)*g*p)
              ...
              spy = half*dtdx*(-u*dpx-w*dpz - (dux+dwz)*g*p)
              ...
              spz = half*dtdx*(-v*dpy-u*dpx - (dvy+dux)*g*p)
